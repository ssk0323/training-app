...
export const MemoStatistics = ({ menuId, isVisible, onClose }: MemoStatisticsProps) => {
      ...
      <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-gray-900">📊 メモ分析レポート</h2>
            <button
              onClick={onClose}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">{statistics.totalMemos}</div>
                    <div className="text-sm text-blue-700">総メモ数</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">{statistics.memoFrequency}%</div>
                    <div className="text-sm text-blue-700">記録率</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">{statistics.averageLength}</div>
              ...
              {frequentWords.length > 0 && (
                <div className="bg-green-50 rounded-lg p-4">
                  <h3 className="font-medium text-green-900 mb-3">🔤 よく使う言葉</h3>
              ...
              <div className="bg-yellow-50 rounded-lg p-4">
                <h3 className="font-medium text-yellow-900 mb-3">😊 感情・状態の傾向</h3>
                <div className="space-y-3">
                  {moodTrends.positive.length > 0 && (
                    <div>
                      <div className="text-sm font-medium text-green-700 mb-1">ポジティブ</div>
                  ...
                  {moodTrends.negative.length > 0 && (
                    <div>
                      <div className="text-sm font-medium text-red-700 mb-1">要注意</div>
                      <div className="flex flex-wrap gap-1">
                  ...
                  {moodTrends.neutral.length > 0 && (
                    <div>
                      <div className="text-sm font-medium text-gray-700 mb-1">標準</div>
                      <div className="flex flex-wrap gap-1">
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                <h3 className="font-medium text-purple-900 mb-3">💡 改善提案</h3>
                <div className="space-y-2 text-sm text-purple-800">
                  {statistics.memoFrequency < 50 && (
                    <div>• メモの記録率が{statistics.memoFrequency}%です。もう少し詳しく記録してみましょう</div>
                  )}
                  {statistics.averageLength < 20 && (
                    <div>• 平均{statistics.averageLength}文字と短めです。感じたことをもう少し詳しく書いてみては？</div>
                  )}
                  {moodTrends.negative.length > moodTrends.positive.length && (
                    <div>• 疲労感に関する記録が多めです。休息も大切にしましょう</div>
                  )}
                  {statistics.memoFrequency >= 80 && statistics.averageLength >= 30 && (
                    <div>• 素晴らしい記録習慣です！継続していきましょう 🎉</div>
                  )}
                </div>
              </div>
            </div>
